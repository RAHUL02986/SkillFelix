  ...
  return (
    <section className="py-16 md:max-w-[1097px] w-full m-auto px-4 bg-white">
      <div className="text-center relative">
        <h2 className="text-3xl md:text-5xl leading-[12%] font-normal mb-5">
          Experience It First: Your Free<br/> <span className="text-[#0B96F3]">Demo Sessions</span>
        </h2>
        <p className="text-[#4F4F4F] text-lg mb-10 max-w-3xl mx-auto">
          Want to see how SkillFelix can jumpstart your career in VLSI and Embedded Systems? Sign up for a free demo session and experience our industry-level training firsthand.
