    ...
    <section className="relative  hero bg-cover md:bg-center bg-right mt-20  bg-no-repeat">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-10 lg:py-16 text-center lg:text-left relative z-10">
        <h1 className="my-5 capitalize text-[#0B96F3] text-4xl lg:text-7xl ">
            Learn   <span className='text-white'>from</span> the Best
        </h1>

        <p className="text-white mt-4 max-w-2xl mx-auto lg:mx-0 text-base sm:text-lg">
          SkillFelix emphasizes job-oriented and online courses, with a strong focus on VLSI and Embedded Systems training. Get comprehensive industry-level training with 24x7 online support and lab access.
        ...
        <div className="w-full max-w-5xl mt-[122px] bg-[#D9D9D90A] backdrop-blur-[64px] rounded-md flex flex-col md:flex-row items-center justify-center md:justify-around py-6 px-6 gap-4 md:gap-0">
