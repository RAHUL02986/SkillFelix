...
const Differentslider = () => {
  const reviews: Review[] = [
    { name: "Best courses", image: "/slideicon1.svg", bgcolor: "#EB5757" },
    { name: "Top market strategies", image: "/slideicon2.svg" },
    { name: "Affordable courses", image: "/slideicon3.svg" },
    { name: "Smooth Career", image: "/slideicon4.svg" },
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-8">
          <h2 className="text-3xl md:text-5xl text-center font-normal">
            We are Making 
 <span className="text-[#0B96F3]"> It Possible</span>
          </h2>
        </div>
