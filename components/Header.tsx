...
const Header = () => {
  ...
  const menuLinks: MenuItem[] = [
    ...
    //   ],
    // },
        { title: 'Careers', href: '/career', submenu: null },
          ...
          <div className="hidden lg:flex items-center space-x-8 text-black">
            {menuLinks.map((link) => (
              ...
              >
                ...
                {link.submenu && (
                  <div
                    className={`absolute top-full left-0 bg-white text-black shadow-lg rounded mt-2 min-w-[150px]  z-20 transition-all duration-200 ease-in-out ${
