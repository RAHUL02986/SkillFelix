                ...
                <div className='md:flex justify-between gap-10 items-center'>
                    ...
                    <div className="w-full md:w-1/2 mt-5 lg:mt-0 text-center md:text-left mx-auto">
                        ...
                        <p className="text-lg  text-[#4F4F4F]">
                            At SkillFelix, we believe in investing in our employees’ success by providing them with the resources, tools, and training they need to excel in their roles. Our comprehensive training and development programs are designed to help our employees stay ahead of the curve and equip them with the skills and knowledge they need to meet the evolving needs of our clients.
                        </p>
                    ...
                    <Image src="/courses/image (1).png" alt="arrow" height={642} width={523}  className='w-full h-full object-cover rounded-xl' />
