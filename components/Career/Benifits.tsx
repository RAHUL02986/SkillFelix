  ...
  export default function Benefits(){
    ...
    const faqData: FAQItem[] = [
      ...
      },
      {
        ...
        answer1:
          'SkillFelix believes in innovation, creativity and skill excellence. We offer a wide range of amazing opportunities to boost work knowledge, develop and enhance leadership abilities, and expand technical and non-technical skills.',
        answer2:
      ...
      },
      {
        ...
        answer4:
          'Flexi work hours and hybrid work mode are the USP of SkillFelix for many years now.',
        answer5:
      ...
      {
        question: 'Merry merry @SkillFelix',
        answer1:
          'We keep the SkillFelix environment and work floor alive, vibrant and happy. Celebrations and Fun is always on the cards in the form of festivals, birthdays, sports events, team outings, casual meets and many more to keep employees well connected and relaxed at work place.',
        image: '/Gallery/acordian6.webp',
      },
      {
        question: 'Culture of appreciation',
        answer1:
          'While learning and development is one of the focus areas, SkillFelix also fosters a culture of appreciation by recognizing and rewarding deserving talent and motivating others to join elite performers.',
        image: '/Gallery/acordian6.webp',
      },
      {
